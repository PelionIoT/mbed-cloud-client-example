...
int32_t arm_pal_storage_init(void)
{
    spifi_config_t config = { 0 };
    uint32_t sourceClockFreq;

    DEBUG_PRINT("arm_pal_storage_init\r\n");
...
int32_t arm_pal_storage_deinit(void)
{
...
int32_t arm_pal_storage_erase_sector(uint32_t address)
{
    int32_t result = -1;

    DEBUG_PRINT("arm_pal_storage_erase_sector: %" PRIX32 "\r\n", address);
...
int32_t arm_pal_storage_read(uint32_t address, uint8_t *data, uint32_t size)
{
    DEBUG_PRINT("arm_pal_storage_read: %" PRIX32 " %p %" PRIX32 "\r\n", address, data, size);
...
int32_t arm_pal_storage_program_page(uint32_t address, const uint8_t *data, uint32_t size)
{
    int32_t result = -1;

    DEBUG_PRINT("arm_pal_storage_program_page: %" PRIX32 " %p %" PRIX32 "\r\n", address, data, size);
...
uint32_t arm_pal_storage_get_sector_size(uint32_t address)
{
    uint32_t sectorsize = 0;

    DEBUG_PRINT("arm_pal_storage_get_sector_size: %" PRIX32 "\r\n", address);
...
uint32_t arm_pal_storage_get_page_size()
{
    return WRITE_PAGE_SIZE;
}

uint32_t arm_pal_storage_get_start_address(void)
{
    return START_ADDRESS;
}

uint32_t arm_pal_storage_get_size(void)
{
    return FLASH_SIZE;
}

uint8_t arm_pal_storage_get_erase_value(void)
{
    return ERASE_VALUE;
}
