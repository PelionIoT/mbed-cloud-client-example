...
if ("${MBED_CLOUD_CLIENT_NATIVE_SDK}" STREQUAL "True")
    ...
    SET(LPC54_MW_ARM_PELION_FLASH_FOLDER ${LPC54_MW_ARM_PELION_ROOT_FOLDER}/kvstore_flashdriver_impl)
else()
    ...
    SET(LPC54_MW_ARM_PELION_FLASH_FOLDER ${APP_ROOT_FOLDER}/kvstore_flashdriver_impl)
...
include_directories(${LPC54_NXP_FOLDER}/middleware/kvstore_flashdriver_impl)
...
if (CMAKE_C_COMPILER_ID STREQUAL "GNU")
    set(CMAKE_EXE_LINKER_FLAGS_DEBUG "${CMAKE_EXE_LINKER_FLAGS_DEBUG} -T${APP_ROOT_FOLDER}/armgcc/${PAL_BOARD_LD_SCRIPT} -static")
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE} -T${APP_ROOT_FOLDER}/armgcc/${PAL_BOARD_LD_SCRIPT} -static")
