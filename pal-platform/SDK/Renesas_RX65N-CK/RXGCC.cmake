...
# RX GCC COMPILLER GENERAL SETTINGS
...
add_custom_command(
    ...
    COMMAND ${CMAKE_OBJCOPY} ${target_dir}/${target_name}.elf -I elf32-rx-be-ns -O ihex ${target_dir}/${target_name}.hex
    COMMAND ${CMAKE_OBJCOPY} ${target_dir}/${target_name}.elf -I elf32-rx-be-ns -O binary --image-base=0xFFE00000 ${target_dir}/${target_name}.bin
    COMMENT "Converting to s-record(.mot), intel-hex (.hex) and binary (.bin)"
    VERBATIM
)
endmacro(ELF_TO_BIN)
...
SET(TOOLCHAIN_FLAGS_FILE "${CMAKE_SOURCE_DIR}/../pal-platform/SDK/Renesas_RX65N-CK/RXGCC-flags.cmake" CACHE INTERNAL "linker flags file")
